    ...
    <section className="py-10 md:py-16 grid grid-cols-1 md:grid-cols-12 gap-8 items-start border-b border-outline-variant/30">
      ...
      <div className="md:col-span-7 flex flex-col gap-5">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-surface-container-low border border-outline-variant/60 w-fit">
          ...
          <span className="font-mono text-[11px] text-primary font-medium tracking-wide uppercase">
        ...
        <div className="pt-2 flex flex-wrap items-center gap-3">
          ...
          <a
            href="#projects"
            className="px-3.5 py-2 rounded-xl bg-surface-container-low border border-outline-variant/50 text-on-surface font-mono text-xs hover:border-primary/50 hover:text-primary transition-all active:scale-[0.98] flex items-center gap-1.5"
          >
          ...
          <div className="flex items-center gap-1.5 pl-1">
            <a
              ...
              className="w-8 h-8 rounded-lg bg-surface-container-low border border-outline-variant/40 flex items-center justify-center text-on-surface-variant hover:text-on-surface hover:border-primary/50 transition-all active:scale-95"
            >
        ...
        >
          ...
          <div className="border-t border-outline-variant/40 pt-2.5">
            <div className="flex items-center justify-between p-2.5 rounded-lg bg-surface-container border border-outline-variant/40 text-xs">
              ...
              <span className="font-mono text-primary font-medium" suppressHydrationWarning>
