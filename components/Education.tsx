        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 flex flex-col justify-between gap-3.5">
            {EDUCATION_DATA.map((edu, idx) => (
              <ScrollReveal key={idx} delay={0.08 + idx * 0.06} className="h-full">
                <div
                  className="p-3.5 rounded-xl bg-surface-container-low border border-black/15 dark:border-outline-variant/40 hover:border-black/35 dark:hover:border-outline-variant transition-all duration-150 flex flex-col justify-between shadow-[0_2px_8px_rgba(0,0,0,0.03)] dark:shadow-none h-full"
                >
                  <div>
